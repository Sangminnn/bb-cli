    ...
    return (
      <div className="bg-github-bg-primary p-4">
        <div className="text-center">
          <div className="mb-2">
            <span className="text-github-danger font-medium">제거된 이미지</span>
          </div>
          <div className="inline-block border border-github-border rounded-md p-4 bg-github-bg-secondary">
            ...
            <img
              ...
              alt={`${file.oldPath || file.path}의 이전 버전`}
  ...
  if (isAdded) {
    return (
      <div className="bg-github-bg-primary p-4">
        <div className="text-center">
          <div className="mb-2">
            <span className="text-github-accent font-medium">추가된 이미지</span>
          </div>
          <div className="inline-block border border-github-border rounded-md p-4 bg-github-bg-secondary">
            <div className="text-github-text-muted mb-2" style={{ fontSize: '14px' }}>
              새 파일:
      ...
      return (
        <div className="bg-github-bg-primary p-4">
          <div className="text-center mb-4">
            <span className="text-github-text-primary font-medium">변경된 이미지</span>
          </div>

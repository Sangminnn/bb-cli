...
export const DiffChunk = memo(function DiffChunk({
  ...
  const submitNewComment = useCallback(
    async (body: string, reviewRequested: boolean) => {
  ...
  const handleSubmitComment = useCallback(
    (body: string) => submitNewComment(body, false),
    [submitNewComment],
  );

  const handleSubmitWithReview = useCallback(
    (body: string) => submitNewComment(body, true),
    [submitNewComment],
  );
